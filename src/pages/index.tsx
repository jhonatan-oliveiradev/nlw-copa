			...
			<main>
				...
				<div className="mt-10 flex items-center gap-2">
					<Image
						...
						alt="avatares de pessoas que estariam participando do bolão"
					/>
				...
				<form onSubmit={createPool} className="mt-10 flex gap-2">
					<input
						className="flex-1 px-6 py-4 rounded bg-gray-800 border border-gray-600 text-sm text-gray-100 focus:outline-none"
						type="text"
						required
